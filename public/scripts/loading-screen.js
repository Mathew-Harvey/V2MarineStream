document.addEventListener('DOMContentLoaded', function() {
    ...
    function startMessageCycle() {
      // Check if loading message element exists
      if (!loadingMessage) {
        console.log('Loading message element not found, skipping message cycle');
        return;
      }
    ...
    function simulateProgress() {
      ...
      if (!progressBar) {
        console.log('Progress bar element not found, skipping progress simulation');
        return;
      }
    ...
    function hideLoadingScreen() {
      ...
      if (!loadingScreen) {
        console.log('Loading screen element not found, removing loading class from body');
